...
### 🎓 HAMA LMS (HAUSA MUSIC ACADEMY)
A full-featured learning management system with:
- Course enrollment & dashboards
- Payment integration (Paystack)
- Quiz & certificate generation
- Multi-lingual UX
- Supabase backend + real-time data

🔗 Live Demo: https://www.hamaacademy.com/
🔗 Repo: https://github.com/Nabil-00/HAMA-LMS-main

---

### 💼 Evelyn Empire
Fashion/services web app with:
- Checkout flows
- Supabase backend
- React frontend

🔗 Live Demo: https://evelynbeaauty.com/

🔗 Repo: https://github.com/Nabil-00/evelyn-empire

---

### 🧠 NorthBridge (Hackathon)
AI-powered payment intelligence system using Squad API  
(adaptive payment plans, smart financial access)
